  ...
  async selectAll(@Query() data: SelectAllDto) {
    ...
    return {
      ...
      data: {
        ...
        high_stage: highStage ? highStage.stage : 0,
        last_stage: lastStage ? lastStage.stage : 0,
        last_is_finished: lastStage ? lastStage.is_finished : false,
        last_is_clear: lastStage ? lastStage.is_clear : false,
